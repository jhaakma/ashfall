...
local function activateDreamCatcher()
    common.log:debug("activate dreamcatcher")
...
local function deactivateDreamCatcher()
    common.log:debug("deactivate dreamcatcher")
...
local function doDreamCatcherEffect(e)
    ...
    --Add Magicka
    common.log:trace("Adding magicka recovery")
    common.log:trace("delta: %s", interval)
    ...
    common.log:trace("magickaRecovery: %s", magickaRecovery)
